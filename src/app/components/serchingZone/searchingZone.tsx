...
export default function SearchingZone({pickData, setPickData, setIsSearch}: PickDataProps) {
    ...
    return (
        <div className={styles.searchingZoneOuterContainer}>
         <h1>Searching Zone</h1>
            <div>
                <label>정상픽</label>
                <input type="radio" name="checkingNormal" value="normal" onChange={handleCheckNormal} checked={checkNormal === "normal"}/>
                <label>즐겜픽</label>
                <input type="radio" name="checkingNormal" value="unNormal" onChange={handleCheckNormal} checked={checkNormal === "unNormal"}/>
            </div>
